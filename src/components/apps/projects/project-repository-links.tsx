...
function GithubIcon() {
    return (
        <svg
            ...
            className={`
                shrink-0
                ${PROJECTS_UI.repository.githubIcon}
            `}
        >
...
function ExternalLinkIcon() {
    return (
        <svg
            ...
            className={`
                shrink-0
                ${PROJECTS_UI.repository.externalIcon}
            `}
        >
            <path d="M15 4h5v5" />
            <path d="M10 14 20 4" />
    ...
    return (
        <div
            className={`
                ...
                shrink-0
                items-center
                ${PROJECTS_UI.repository.wrapperGap}
            `}
        >
            {repositories
                .slice(0, PROJECTS_LIMITS.repositories)
                .map((repository) => (
                    <a
                        ...
                        className={`
                            ...
                            ${PROJECTS_UI.repository.button}
                        `}
                    >
                        <GithubIcon />

                        <span className={PROJECTS_UI.repository.label}>
                            {repository.label}
                        </span>
